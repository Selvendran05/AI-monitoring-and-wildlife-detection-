...
RECEIVER_EMAILS = ["sakthimanikandanm01@gmail.com","akilraj833@gmail.com","selvendran.akash@gmail.com"]
EMAIL_PASSWORD = "nhhqkkbverhxmmgn"
...
# === Detection Loop ===
cap = cv2.VideoCapture("attack.mp4")  # or use 0 for webcam
frame_count = 0
